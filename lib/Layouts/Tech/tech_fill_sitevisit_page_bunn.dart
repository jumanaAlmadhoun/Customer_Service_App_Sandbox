...
class TechFillTicketPageBunn extends StatefulWidget {
  const TechFillTicketPageBunn(this.ticket, {Key? key}) : super(key: key);
  final Ticket? ticket;
  @override
  _TechFillTicketPageBunnState createState() => _TechFillTicketPageBunnState();
}

class _TechFillTicketPageBunnState extends State<TechFillTicketPageBunn>
    with RouteAware {
  double totalPrice = 0;
