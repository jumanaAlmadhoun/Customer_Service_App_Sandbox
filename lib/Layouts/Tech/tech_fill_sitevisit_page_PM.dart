...
class TechFillTicketPagePM extends StatefulWidget {
  const TechFillTicketPagePM(this.ticket, {Key? key}) : super(key: key);
  final Ticket? ticket;
  @override
  _TechFillTicketPagePMState createState() => _TechFillTicketPagePMState();
}

class _TechFillTicketPagePMState extends State<TechFillTicketPagePM>
    with RouteAware {
  double totalPrice = 0;
